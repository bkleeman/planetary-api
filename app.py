...
app.config['JWT_SECRET_KEY'] = 'super-secret' # change in real life
app.config['MAIL_SERVER']='smtp.mailtrap.io'
app.config['MAIL_PORT'] = 2525
app.config['MAIL_USERNAME'] = '690fae6bc67c7c'
app.config['MAIL_PASSWORD'] = 'a9c3a26c5a0421'
...
def super_simple():
    return jsonify(message='Hello from the Planetary API. Yep. Mhm.')
